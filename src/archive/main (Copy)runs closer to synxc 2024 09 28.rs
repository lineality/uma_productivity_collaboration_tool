...
struct SyncCollaborator {
    ...
    sync_interval: u64, 
    uniq_signal_port: u16,        // Add the signal port
}
...
//         gpg_key_public: String,
//         uniq_signal_port: u16, // Add uniq_signal_port
    ...
    if !dir_at_path_is_empty_returns_false(Path::new("project_graph_data/collaborator_tomls")) { 
      ...
      // Prompt for IPv6 addresses (potentially multiple):
        ...
        add_collaborator_setup_file(
            ...
            gpg_key_public, 
            40000, // TODO: pick a random number 
            40001, // TODO: pick a random number 
...
fn load_teamchannel_connection_data() -> Result<HashSet<SyncCollaborator>, MyCustomError> { 
    ...
    */
    ...
    for member_username in &channel_members {
        ...
        //             uniq_signal_port: collaborator.uniq_signal_port,
        //         });
        //     } 
        // } 
